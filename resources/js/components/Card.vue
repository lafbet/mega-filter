    ...
    <card class="mega-filter flex flex-col p-6" @dblclick.native.self="toggleAllSections">
        ...
        <div class="mega-filter__columns" v-if="hasColumns">
            <Section v-if="sections.columns"
                    ...
                    @reset="resetColumns">
                <div class="pb-2" v-for="column of columns" :class="[ card.settings.columnsWidth ]" :key="column.attribute">
      ...
      <div class="mega-filter__filters">
          <div v-if="hasFilters && this.sections.filters">
              <Section v-if="sections.filters"
                  ...
                  <!-- <card class="filters w-full border border-gray-200 dark:border-gray-700 bg-40 shadow-none p-4 flex flex-wrap"> -->
                  <card class="filters w-full bg-40 shadow-none flex flex-wrap">
                      <component class="flex flex-col inline-flex"
                                 :class="[ filter.component, card.settings.filtersWidth ]"
      ...
      <div class="mega-filter__actions" v-if="hasActions">
          <Section v-if="sections.actions" :title="settings.actionsSectionTitle">
              ...
              <div v-for="message, key of actionMessages" :key="key"
...
<script>
//   import { CollapseTransition, FadeTransition } from 'vue3-transitions'
  import { mapProps } from 'laravel-nova'
  import Section from './elements/Section'
  import Button from './elements/Button'
  import Filterable from '~~nova~~/mixins/Filterable'
  ...
  export default {
    //   name: 'MegaFilter',
    mixins: [ Filterable, HandlesActions, InteractsWithQueryString ],
    ...
    data() {
        ...
        return {
            ...
            fieldsModel: {},
            actionMessages: [],
            filterKey: 'Lafbet\\MegaFilter\\MegaFilterColumns',
            sections: sections || {
    ...
    methods: {
        ...
        actionFormData() {
            ...
            console.log('filters', this.$route.query[ this.resourceName + '_filter' ]);
